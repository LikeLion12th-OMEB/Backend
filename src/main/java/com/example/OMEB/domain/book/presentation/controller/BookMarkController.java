...
public class BookMarkController {
    ...
    @AssignUserId
    public ResponseEntity<ResponseBody<Void>> saveBookMark(Long userId , @PathVariable @Schema(description = "책 id",example = "1") Long bookId) {
    ...
    @AssignUserId
    public ResponseEntity<ResponseBody<Void>> deleteBookMark(Long userId,
